...
The release was exercised on Windows using v24.14.0. The offline test run passed 6 tests (0 skipped); the offline example exited successfully. Tests took 109 ms and the example 46 ms in this observation. These timings are not a benchmark or performance guarantee.
...
Recorded: 2026-09-10T19:39:13.301Z.
